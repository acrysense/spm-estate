    ...
    optionsList.forEach(function (option) {
      option.addEventListener('click', function (event) {
        ...
        if (option.querySelector('input').checked) {
          ...
          var selectedLength = parent.querySelectorAll('input:checked').length;
          if (selectedLength >= 1) {
            currentSelectedValue.querySelector('span').innerHTML = selectedLength;
          } else {
            if (!currentSelectedPlaceholder.classList.contains('select-box__placeholder--active')) {
              currentSelectedPlaceholder.classList.add('select-box__placeholder--active');
              currentSelectedValue.classList.remove('select-box__values--active');
            }
            currentSelectedValue.querySelector('span').innerHTML = '';
          }
        } else {
          option.querySelector('input').checked = true;
          var _selectedLength = parent.querySelectorAll('input:checked').length;
          if (currentSelectedPlaceholder.classList.contains('select-box__placeholder--active')) {
          ...
          currentSelectedValue.querySelector('span').innerHTML = _selectedLength;
        }
      });
    });
  }
